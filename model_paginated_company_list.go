...
func (o *PaginatedCompanyList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedCompanyList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
func (o PaginatedCompanyList) MarshalJSON() ([]byte, error) {
...
func (v *PaginatedCompanyList) UnmarshalJSON(src []byte) error {
    type PaginatedCompanyListUnmarshalTarget PaginatedCompanyList

	var intermediateResult PaginatedCompanyListUnmarshalTarget
	...
	*v = PaginatedCompanyList(intermediateResult)
	return nil
}
type NullablePaginatedCompanyList struct {
	value *PaginatedCompanyList
	isSet bool
}

func (v NullablePaginatedCompanyList) Get() *PaginatedCompanyList {
	return v.value
}

func (v *NullablePaginatedCompanyList) Set(val *PaginatedCompanyList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedCompanyList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedCompanyList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedCompanyList(val *PaginatedCompanyList) *NullablePaginatedCompanyList {
	return &NullablePaginatedCompanyList{value: val, isSet: true}
}

func (v NullablePaginatedCompanyList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedCompanyList) UnmarshalJSON(src []byte) error {
	v.isSet = true
