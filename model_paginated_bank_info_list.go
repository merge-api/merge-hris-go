...
func (o *PaginatedBankInfoList) SetNextNil() {
	o.Next.Set(nil)
}
...
func (o *PaginatedBankInfoList) SetPreviousNil() {
	o.Previous.Set(nil)
}
...
// SetResults gets a reference to the given []BankInfo and assigns it to the Results field.
func (o *PaginatedBankInfoList) SetResults(v []BankInfo) {
	o.Results = &v
}

func (o PaginatedBankInfoList) MarshalJSON() ([]byte, error) {
...
func (v *PaginatedBankInfoList) UnmarshalJSON(src []byte) error {
    type PaginatedBankInfoListUnmarshalTarget PaginatedBankInfoList

	var intermediateResult PaginatedBankInfoListUnmarshalTarget
	...
	*v = PaginatedBankInfoList(intermediateResult)
	return nil
}
type NullablePaginatedBankInfoList struct {
	value *PaginatedBankInfoList
	isSet bool
}

func (v NullablePaginatedBankInfoList) Get() *PaginatedBankInfoList {
	return v.value
}

func (v *NullablePaginatedBankInfoList) Set(val *PaginatedBankInfoList) {
	v.value = val
	v.isSet = true
}

func (v NullablePaginatedBankInfoList) IsSet() bool {
	return v.isSet
}

func (v *NullablePaginatedBankInfoList) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePaginatedBankInfoList(val *PaginatedBankInfoList) *NullablePaginatedBankInfoList {
	return &NullablePaginatedBankInfoList{value: val, isSet: true}
}

func (v NullablePaginatedBankInfoList) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePaginatedBankInfoList) UnmarshalJSON(src []byte) error {
	v.isSet = true
