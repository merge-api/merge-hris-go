...
const (
	AMERICAN_INDIAN_OR_ALASKA_NATIVE EthnicityEnum = "AMERICAN_INDIAN_OR_ALASKA_NATIVE"
	ASIAN_OR_INDIAN_SUBCONTINENT EthnicityEnum = "ASIAN_OR_INDIAN_SUBCONTINENT"
	BLACK_OR_AFRICAN_AMERICAN EthnicityEnum = "BLACK_OR_AFRICAN_AMERICAN"
	HISPANIC_OR_LATINO EthnicityEnum = "HISPANIC_OR_LATINO"
	NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER EthnicityEnum = "NATIVE_HAWAIIAN_OR_OTHER_PACIFIC_ISLANDER"
	TWO_OR_MORE_RACES EthnicityEnum = "TWO_OR_MORE_RACES"
	WHITE EthnicityEnum = "WHITE"
	PREFER_NOT_TO_DISCLOSE EthnicityEnum = "PREFER_NOT_TO_DISCLOSE"
)
