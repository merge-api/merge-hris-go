...
func (r ApiLinkTokenCreateRequest) EndUserDetails(endUserDetails EndUserDetails) ApiLinkTokenCreateRequest {
	r.endUserDetails = &endUserDetails
	return r
}
...
func (a *LinkTokenApiService) LinkTokenCreateExecute(r ApiLinkTokenCreateRequest) (LinkToken, *_nethttp.Response, GenericOpenAPIError) {
	...
	if r.endUserDetails == nil {
		executionError.error = "endUserDetails is required and must be specified"
		return localVarReturnValue, nil, executionError
	}
	...
	// body params
	localVarPostBody = r.endUserDetails
	if r.ctx != nil {
