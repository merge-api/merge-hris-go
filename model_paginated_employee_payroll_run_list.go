...
func (v *PaginatedEmployeePayrollRunList) UnmarshalJSON(src []byte) error {
    type PaginatedEmployeePayrollRunListUnmarshalTarget PaginatedEmployeePayrollRunList

	var intermediateResult PaginatedEmployeePayrollRunListUnmarshalTarget
	...
	*v = PaginatedEmployeePayrollRunList(intermediateResult)
	return nil
}
